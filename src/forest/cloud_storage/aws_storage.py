...
class SimpleStorageService:
    ...
    @staticmethod
    def read_object(object_name: Union[List, object], decode: bool = True, make_readable: bool = False) -> Union[StringIO, str]:
        """
        ...
        try:
            # Check if the object_name is a list and handle accordingly
            if isinstance(object_name, list):
                if len(object_name) == 1:
                    object_name = object_name[0]  # Use the first object if it's a list
                else:
                    raise ValueError("Multiple objects found, cannot read.")
    ...
    def get_file_object(self, filename: str, bucket_name: str) -> Union[object, List[object]]:
        ...
        Output      :   Object is returned based on filename
        On Failure  :   Write an exception log and then raise an exception
        """
        ...
        try:
            ...
            if len(file_objects) == 1:
                ...
                # If multiple objects are found, return the first one or handle as needed
                return file_objects[0]
            else:
                raise ValueError(f"No file found with the name {filename}")
    ...
    def load_model(self, model_name: str, bucket_name: str, model_dir: str = None) -> object:
        ...
        Description :   This method loads the model_name model from bucket_name bucket
        Output      :   Model object is returned based on the filename
        On Failure  :   Write an exception log and then raise an exception
        """
    ...
    def upload_df_as_csv(self, data_frame: DataFrame, local_filename: str, bucket_filename: str, bucket_name: str) -> None:
        ...
        Output      :   DataFrame is uploaded as a CSV to s3 bucket
        On Failure  :   Write an exception log and then raise an exception
        """
